      ...
      <div style={{ margin: "auto" }} className="section-content-max-width">
        ...
        <div className="articles-row">
          <div className="article-card">
            ...
            <Heading3 className="article-card-title">Título del Artículo 1</Heading3>
          </div>
          <div className="article-card">
            <img src="/images/article2.jpg" alt="Artículo 2" className="article-image" />
            <Heading3 className="article-card-title">Título del Artículo 2</Heading3>
          </div>
          <div className="article-card">
            <img src="/images/article3.jpg" alt="Artículo 3" className="article-image" />
            <Heading3 className="article-card-title">Título del Artículo 3</Heading3>
          </div>
        </div>
      </div>
    </section>
